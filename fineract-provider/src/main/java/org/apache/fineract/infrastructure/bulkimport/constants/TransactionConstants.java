...
public final class TransactionConstants {
    ...
    public static final int LOOKUP_CLIENT_NAME_COL = 14;
    public static final int LOOKUP_ACCOUNT_NO_COL = 15;
    public static final int LOOKUP_PRODUCT_COL = 16;
    public static final int LOOKUP_OPENING_BALANCE_COL = 17;
    public static final int LOOKUP_SAVINGS_ACTIVATION_DATE_COL = 18;
}
