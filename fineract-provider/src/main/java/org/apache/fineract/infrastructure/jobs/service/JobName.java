                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    "Notify Failed Standing Instructions"), POST_LOAN_OVERDUE_REMINDER(
                                                                                                                                                                                                                                                                                            "Post Loan Overdue Reminder"), PROCESS_LOAN_OVERDUE_REMINDER(
                                                                                                                                                                                                                                                                                                    "Process Loan Overdue Reminder"), UPDATE_NEXT_WITHDRAWAL_DATE_ON_SAVINGS_ACCOUNT(
                                                                                                                                                                                                                                                                                                            "Update next withdrawal date for savings account"), PROCESS_TOTAL_AMOUNT_DUE_FOR_FAILED_STANDING_INSTRUCTIONS(
                                                                                                                                                                                                                                                                                                                    "Process Amount Due For Failed Standing Instructions"),SEND_NOTIFICATION_ALERT_TO_CHECKER_USERS("Send Notification Alert to Checker users"),;
