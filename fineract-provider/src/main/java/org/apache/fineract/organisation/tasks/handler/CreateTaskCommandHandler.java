...
@Service
@CommandType(entity = "TASKS", action = "ADD")
public class CreateTaskCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public CreateTaskCommandHandler(final TaskWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.createTask(command);
    }
}
