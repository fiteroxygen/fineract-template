...
/**
 * <p>
 * Wrapper for {@link TaskRepository} that adds NULL checking and Error handling capabilities
 * </p>
 */
@Service
public class TaskRepositoryWrapper {
    ...
    public Task findOneWithNotFoundDetection(final Long id) {
        return this.repository.findById(id).orElseThrow(() -> new TaskNotFoundException(id));
    }
